package com.example.dex.popularmovies.utils;
...
public class Utils {
    ...
    public static boolean isValidApiKey() {
        return !MovieDBServiceAPI.API_KEY.equals("YOUR_API") &&
    ...
    public static String timeToDisplay(String duration) {
        ...
        String hourSymbol = " hr ";
        String minSymbol = " mins";
        if (duration == null || duration.isEmpty())
            ...
            int min = runtime % 60;
            if (min < 10)
                timeToDisplay = hours + hourSymbol + min + minSymbol;
            else
                timeToDisplay = hours + hourSymbol + min + minSymbol;
